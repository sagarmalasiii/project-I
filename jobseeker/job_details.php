...
<body>
    ...
    <div class="content">
        ...
        <form method="POST" id="applyForm">
            <button type="submit" class="apply-btn" id="applyButton" <?php echo !$resume_path ? 'disabled' : ''; ?>>Apply</button>
        </form>

        <?php if (!$resume_path): ?>
            <p style="color: red;">Please upload your resume to apply for this job.</p>
        <?php endif; ?>
    </div>
