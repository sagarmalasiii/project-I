...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $update_sql = "UPDATE job_seeker SET full_name = '$full_name', email = '$email', username = '$username', profile_picture = '$profile_picture', resume_path = '$cv_file' WHERE job_seeker_id = '$user_id'";
